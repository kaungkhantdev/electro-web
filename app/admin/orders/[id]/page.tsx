...
const sampleOrders: Record<string, OrderData> = {
    ...
    timeline: [
      {
        ...
        detail: "Customer placed order via website",
      },
    ],
  },
  "2": {
    ...
    items: [
      ...
      { name: "AirPods Pro 2", sku: "APP-2-USB", quantity: 1, price: 249.0 },
      {
    ...
    timeline: [
      ...
      },
      {
        ...
        date: "2025-02-09 10:16",
        detail: "PayPal payment confirmed",
      },
      {
        event: "Processing started",
        date: "2025-02-09 14:00",
        detail: "Warehouse picking items",
      },
    ],
  },
  "3": {
    ...
    timeline: [
      {
        event: "Order placed",
        date: "2025-02-08 09:22",
        detail: "Customer placed order via website",
      },
      {
        event: "Payment received",
        date: "2025-02-08 09:23",
        detail: "Credit card payment confirmed",
      },
      {
        event: "Processing started",
      ...
      {
        event: "Shipped",
        date: "2025-02-09 08:30",
        detail: "Tracking: 1Z999AA10123456784",
      },
    ],
  },
  "5": {
    ...
    timeline: [
      ...
      {
        event: "Shipped",
        date: "2025-02-02 09:15",
        detail: "Tracking: 1Z999AA10123456790",
      },
      {
        event: "Delivered",
  ...
  "12": {
    ...
    timeline: [
      ...
      {
        event: "Cancelled",
        date: "2025-01-05 13:20",
        detail: "Customer requested cancellation",
      },
      {
        event: "Refunded",
        date: "2025-01-06 10:00",
        detail: "Full refund processed to original payment method",
      },
    ],
  },
};
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <Badge
                  ...
                  className={sCfg.className}
                >
                  {sCfg.label}
                </Badge>
                <Badge
                  variant={
                    order.paymentStatus === "refunded" ? "secondary" : "default"
                  }
                  ...
                  <tbody className="divide-y">
                    {order.items.map((item, i) => (
                      <tr key={i}>
                        ...
                        <td className="py-3 text-sm text-center tabular-nums">
                          {item.quantity}
                        </td>
