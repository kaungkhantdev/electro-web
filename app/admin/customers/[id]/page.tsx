  ...
  "1": {
    ...
    recentReviews: [
      ...
      },
      {
        ...
        rating: 4,
        comment: "Great sound and noise cancellation.",
        date: "2025-01-10",
      },
    ],
  },
    ...
    recentReviews: [
      {
        ...
        rating: 3,
        comment: "Good device but too expensive.",
        date: "2025-01-13",
      },
    ],
  },
    ...
    recentReviews: [
      {
        ...
        rating: 5,
        comment: "Perfect for my outdoor activities!",
        date: "2025-01-12",
      },
    ],
  },
    ...
    recentReviews: [
      {
        ...
        rating: 5,
        comment: "Best Android phone on the market.",
        date: "2025-02-01",
      },
    ],
  },
...
export default async function CustomerDetailPage({
  ...
  const memberDays = Math.floor(
    (dateNow - new Date(customer.joinedDate).getTime()) / (1000 * 60 * 60 * 24),
  );
  const loyaltyTier =
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <Badge className={loyaltyColor}>{loyaltyTier}</Badge>
              </div>
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-muted-foreground text-xs">
                  {customer.recentReviews.length} reviews
                </span>
              </div>
