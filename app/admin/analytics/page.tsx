...
const recentActivity = [
  {
    ...
    detail: "$45K monthly revenue achieved",
    time: "2h ago",
    type: "success" as const,
  },
  {
    event: "Traffic spike",
    detail: "+340% visitors from social campaign",
    time: "5h ago",
    type: "info" as const,
  },
  {
    event: "High bounce rate",
    detail: "/products/deals page at 68%",
    time: "8h ago",
    type: "warning" as const,
  },
  {
    event: "New record",
    detail: "512 orders in a single day",
    time: "1d ago",
    type: "success" as const,
  },
  {
    event: "Low conversion",
    detail: "Mobile checkout at 1.8%",
    time: "1d ago",
    type: "warning" as const,
  },
];
              ...
              {recentActivity.map((item, index) => (
                <div key={index} className="flex items-start gap-3">
                  <div className="mt-0.5">
                    <Badge
                      className={`text-[10px] px-1.5 py-0 ${activityTypeConfig[item.type]}`}
                    >
                      {item.type === "success"
                        ? "Good"
                        : item.type === "info"
