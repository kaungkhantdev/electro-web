...
const samplePayouts: Payout[] = [
  {
    id: "1",
    payoutId: "po_8A9B0C1D2E",
    amount: 15230.45,
    fee: 0,
    net: 15230.45,
    transactions: 47,
    bankAccount: { bankName: "Chase Bank", last4: "6789", type: "Checking" },
    status: "paid",
    initiatedDate: "2025-01-10",
    arrivalDate: "2025-01-12",
    description: "Weekly payout - Jan 6-10",
  },
  {
    id: "2",
    payoutId: "po_3F4G5H6I7J",
    amount: 8945.2,
    fee: 0,
    net: 8945.2,
    transactions: 31,
    ...
    description: "Weekly payout - Jan 13-14",
  },
  {
    id: "3",
    payoutId: "po_8K9L0M1N2O",
    amount: 12567.89,
    fee: 0,
    net: 12567.89,
    transactions: 38,
    ...
    description: "Weekly payout - Jan 15",
  },
  {
    id: "4",
    payoutId: "po_3P4Q5R6S7T",
    amount: 22340.0,
    fee: 0,
    net: 22340.0,
    transactions: 68,
    ...
    description: "Weekly payout - Dec 30 - Jan 3",
  },
  {
    id: "5",
    payoutId: "po_8U9V0W1X2Y",
    amount: 18920.55,
    fee: 0,
    net: 18920.55,
    transactions: 56,
    bankAccount: { bankName: "Chase Bank", last4: "6789", type: "Checking" },
    status: "paid",
    initiatedDate: "2024-12-27",
    arrivalDate: "2024-12-29",
    description: "Weekly payout - Dec 23-27",
  },
  {
    id: "6",
    payoutId: "po_3Z4A5B6C7D",
    amount: 14785.3,
    fee: 0,
    net: 14785.3,
    transactions: 42,
    bankAccount: { bankName: "Chase Bank", last4: "6789", type: "Checking" },
    status: "paid",
    initiatedDate: "2024-12-20",
    arrivalDate: "2024-12-22",
    description: "Weekly payout - Dec 16-20",
  },
  {
    id: "7",
    payoutId: "po_8E9F0G1H2I",
    amount: 21450.0,
    fee: 0,
    net: 21450.0,
    transactions: 63,
    ...
    description: "Weekly payout - Dec 9-13",
  },
  {
    id: "8",
    payoutId: "po_3J4K5L6M7N",
    amount: 9870.65,
    fee: 0,
    net: 9870.65,
    transactions: 29,
    bankAccount: { bankName: "Chase Bank", last4: "6789", type: "Checking" },
    status: "paid",
    initiatedDate: "2024-12-06",
    arrivalDate: "2024-12-08",
    description: "Weekly payout - Dec 2-6",
  },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-sm text-muted-foreground text-center">
        Showing {samplePayouts.length} payouts · Total paid out: $
        {samplePayouts
