...
const sampleTransactions: Transaction[] = [
  ...
  },
  {
    ...
    cardLast4: "9999",
    status: "failed",
    date: "2025-01-12T17:15:00",
  },
  {
    id: "8",
    transactionId: "txn_8J9K0L1M2N",
    orderId: "ORD-001241",
    customer: {
      name: "Fiona Garcia",
    ...
    method: "paypal",
    status: "succeeded",
    date: "2025-01-12T13:45:00",
  },
  {
    id: "9",
    transactionId: "txn_9O0P1Q2R3S",
    orderId: "ORD-001242",
    customer: { name: "George Kim", email: "george@example.com", avatar: "GK" },
    amount: 1849.0,
    fee: 53.62,
    net: 1795.38,
    method: "card",
    ...
    cardLast4: "7890",
    status: "succeeded",
    date: "2025-01-11T08:20:00",
  },
  {
    id: "10",
    transactionId: "txn_0T1U2V3W4X",
    orderId: "ORD-001243",
    customer: { name: "Hannah Lee", email: "hannah@example.com", avatar: "HL" },
    amount: 679.0,
    fee: 19.69,
    net: 659.31,
    method: "card",
    ...
    cardLast4: "3333",
    status: "pending",
    date: "2025-01-11T15:50:00",
  },
  {
    id: "11",
    transactionId: "txn_1Y2Z3A4B5C",
    orderId: "ORD-001244",
    customer: { name: "Ivan Torres", email: "ivan@example.com", avatar: "IT" },
    amount: 3299.0,
    fee: 95.67,
    net: 3203.33,
    method: "bank_transfer",
  ...
  {
    id: "12",
    transactionId: "txn_2D3E4F5G6H",
    orderId: "ORD-001245",
    customer: { name: "Julia Chen", email: "julia@example.com", avatar: "JC" },
    amount: 159.0,
    fee: 4.61,
    net: 154.39,
    method: "paypal",
    status: "refunded",
    date: "2025-01-10T11:35:00",
  },
];
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <span className="font-medium text-sm tabular-nums">
        $
        {row.original.net.toLocaleString("en-US", { minimumFractionDigits: 2 })}
      </span>
    ),
  },
  {
      ...
      <div className="flex items-center justify-between text-sm text-muted-foreground">
        ...
        <div className="flex items-center gap-4 tabular-nums">
          ...
          <span>
            Fees:{" "}
            <strong className="text-foreground">
              ${filtered.reduce((sum, t) => sum + t.fee, 0).toFixed(2)}
            </strong>
          </span>
          <span>
            Net:{" "}
